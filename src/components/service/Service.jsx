...
const Service = () => {
    return (
        <div className="md:p-8 p-3 bg-[#FFFFF5] md:grid md:grid-cols-2 gap-12 mt-40">
            <div className="">
            ...
            <div className="bg-[url('https://i.ibb.co/v4HfCbV/Rectangle-27-2.png')] bg-no-repeat rounded-[30px] flex items-end p-5">
