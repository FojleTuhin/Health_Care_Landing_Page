            ...
            <div className="space-y-3">
                ...
                <div className="collapse collapse-arrow ">
                    ...
                    <div className="collapse-content ">
                        <hr />
                        <p className="mt-4 mx-11 opacity-[0.6] text-[#343268] text-[14px]">Our office hours vary by location, but typically we are open Monday through Friday from 8:00 AM to 5:00 PM. Some locations may offer extended hours or weekend appointments. Please contact your nearest clinic for specific hours.</p>
                    </div>
                </div>
                <div className="collapse collapse-arrow ">
