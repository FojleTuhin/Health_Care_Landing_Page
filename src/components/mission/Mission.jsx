...
const Mission = () => {
    return (
        <div className=" mt-40 gap-5 md:flex mb-20 bg-[url('https://i.ibb.co/GRWPbLX/Rectangle-24.png')] bg-no-repeat bg-right-top bg-contain">
            <div className="md:w-[40%] p-5 md:p-0">
                <button className="btn bg-[#FFFFF5] py-[11px] px-6 rounded-3xl text-[#020043] mb-4 mt-44 md:mt-0">Who we are</button>
